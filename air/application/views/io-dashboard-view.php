							...
							<tbody id="user_tbody">
					            ...
					            {  ?> 
					                ...
					                <td class="text-center">
					                	...
					                	<?php } else if (empty($row['sro'])) { ?>
					                		<button type="button" class="btn btn-sm-main" onclick="assign_marks('<?php echo $row['user_id']; ?>');">Edit</button>
					                	<?php } else {  ?>
...
<script src="<?php echo base_url(); ?>assets/custom_js/io_dashboard.js?v=1.2"></script>
